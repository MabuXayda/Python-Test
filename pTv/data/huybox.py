...
#%%
huy = pd.read_csv(DIR + "support/using/huyboxUser.csv",parse_dates = ["Date","StopDate"], infer_datetime_format = True, dayfirst=True, index_col=0)
...
huy_check["Check"] = huy_check["DayActive"] < 28
print huy_check["Check"].value_counts()
nah = huy_check[huy_check["DayActive"] < 28]
print huy["StopMonth"].value_counts()
